        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IconPath = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOneClick = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    OneClickAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessingFee = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    ProcessorName = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivatedFrom = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ActivatedTo = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())"),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreOrderReleaseDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())"),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_AnimeSeries_AnimeSeriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderShippingMethods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderShippingMethods_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderShippingMethods_ShippingMethods_ShippingMethodId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAddresses_AddressType",
                table: "UserAddresses",
                column: "AddressType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffProfiles_Active",
                table: "StaffProfiles",
                column: "UserId",
                unique: true,
                filter: "LeaveDate IS NULL");

            migrationBuilder.CreateIndex(
                name: "IX_StaffProfiles_HireDate",
                table: "StaffProfiles",
                column: "HireDate",
                filter: "HireDate IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_StaffProfiles_Position",
                table: "StaffProfiles",
                column: "Position",
                filter: "Position IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_StaffProfiles_Salary",
                table: "StaffProfiles",
                column: "Salary",
                filter: "Salary IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerProfiles_DateOfBirth",
                table: "CustomerProfiles",
                column: "DateOfBirth",
                filter: "DateOfBirth IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerProfiles_Gender",
                table: "CustomerProfiles",
                column: "Gender",
                filter: "Gender IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_AnimeSeries_ImagePath",
                table: "AnimeSeries",
                column: "ImagePath",
                filter: "ImagePath IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_AnimeSeries_ReleaseYear",
                table: "AnimeSeries",
                column: "ReleaseYear",
                filter: "ReleaseYear IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Badges_ConditionType",
                table: "Badges",
                column: "ConditionType");

            migrationBuilder.CreateIndex(
                name: "IX_Badges_EndDate",
                table: "Badges",
                column: "EndDate",
                filter: "EndDate IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Badges_IconPath",
                table: "Badges",
                column: "IconPath",
                filter: "IconPath IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Badges_IsTimeLimited",
                table: "Badges",
                column: "IsTimeLimited");

            migrationBuilder.CreateIndex(
                name: "IX_Badges_StartDate",
                table: "Badges",
                column: "StartDate",
            ...
            migrationBuilder.CreateIndex(
                ...
                filter: "PostCategoryId IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Coupons",
                column: "UsageLimit",
                filter: "UsageLimit IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_EventProducts_EventId_ProductId",
                table: "EventProducts",
                columns: new[] { "EventId", "ProductId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EventProducts_IsFeatured",
                table: "EventProducts",
                column: "IsFeatured");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderShippingMethods_OrderId",
                table: "OrderShippingMethods",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderShippingMethods_ShippingMethodId",
                table: "OrderShippingMethods",
                column: "ShippingMethodId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderShippingMethods_TrackingNumber",
                table: "OrderShippingMethods",
                column: "TrackingNumber",
                filter: "TrackingNumber IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_IconPath",
                table: "PaymentMethods",
                column: "IconPath",
                filter: "IconPath IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_IsOnlinePayment",
                table: "PaymentMethods",
                column: "IsOnlinePayment");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_ProcessorName",
                table: "PaymentMethods",
                column: "ProcessorName",
                filter: "ProcessorName IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Payments",
                column: "PaymentDate",
                filter: "PaymentDate IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_AnimeSeriesId",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingMethods_EstimatedDays",
                table: "ShippingMethods",
                column: "EstimatedDays",
                filter: "EstimatedDays IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserActions_UserId_CreatedAt",
                table: "UserActions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBadges_EarnedDate",
                table: "UserBadges",
                column: "EarnedDate");

            migrationBuilder.CreateIndex(
                name: "IX_UserBadges_IsActive",
                table: "UserBadges",
                column: "IsActive");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCoupons_UsedDate",
                table: "UserCoupons",
                column: "UsedDate",
                filter: "UsedDate IS NOT NULL");
