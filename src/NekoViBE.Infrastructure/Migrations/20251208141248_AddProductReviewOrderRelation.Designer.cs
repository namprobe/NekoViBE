...
namespace NekoViBE.Infrastructure.Migrations
{
    ...
    [Migration("20251208141248_AddProductReviewOrderRelation")]
    partial class AddProductReviewOrderRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NekoViBE.Domain.Entities.OrderShippingMethod", b =>
                {
                    ...
                    b.HasOne("NekoViBE.Domain.Entities.UserAddress", "UserAddress")
                        .WithMany()
